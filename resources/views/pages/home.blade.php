			...
			<ul class="rslides" id="slider">
				...
				<li>
						...
						<div class="col-md-6 men">
							<a href="/home/single/{{$coba->id}}" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="{{url('storage/'.$coba->gambar)}}" alt="">
								<div class="b-wrapper">
									<h3 class="b-animate b-from-top top-in   b-delay03 ">
										<span>{{$coba->nama_barang}}</span>
									</h3>
								</div>
							</a>
						</div>
				...
				<div class="col-md-6">
					...
					<div class="col-md2">
						<div class="col-md-6 men1">
							...
							<div class="col-md2">
								<div class="col-md-6 men1">
									<a href="/home/single" class="b-link-stripe b-animate-go  thickbox"><img class="img-responsive" src="{{url('storage/'.$coba->gambar)}}" alt="">
										<div class="b-wrapper">
